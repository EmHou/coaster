...
// For boards not covered by the specific conditionals (e.g. Renesas UNO WiFi R4),
// define regtype and regsize as 16-bit types (to match portOutputRegister on your board).
#ifndef regtype
  typedef volatile uint16_t regtype;
#endif
...
// Provide fallback definitions for sbi and cbi if not already defined.
#ifndef sbi
